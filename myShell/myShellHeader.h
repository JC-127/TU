...
void BatchExecute(int position, char** condition2, char* condition1[], char* stringFile);
void ReadingCommand(int argc, char** condition2, char* condition1[], char* stringFile);
